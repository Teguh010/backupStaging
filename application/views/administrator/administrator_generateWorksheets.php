					...
					<ul class="list-group smartgen-list-group">
						<?php
							...
							foreach ($questionList AS $question) {
								...
								echo '<a href="'.base_url().'administrator/regenerateQuestion_admin" id="regen_'.$quesNum.'" class="btn btn-custom pull-right regen_question" data-toggle="tooltip" data-placement="top" title="Regenerate this question, please">Regenerate</a>';
