			...
			<div class="panel panel-success panel-success-custom-dark">
			  ...
			  <!-- Default panel contents -->
			  	...
			  	<div class="panel-heading clearfix">
			  		...
			  		<form class="form-horizontal" action="<?php echo base_url(); ?>administrator/generateWorksheet/<?php echo (isset($worksheetId))?$worksheetId:''; ?>" method="post" accept-charset="utf-8">
					...
					<ul class="list-group smartgen-list-group">
						...
						<?php
							...
							foreach ($questionList AS $question) {
								...
								if($this->session->userdata('worksheetSubject') != 7) {
									echo '<a href="'.base_url().'administrator/regenerateQuestion_admin" id="regen_'.$quesNum.'" class="btn btn-custom pull-right regen_question_admin" data-toggle="tooltip" data-placement="top" title="Regenerate this question, please">Regenerate</a>';
								} else {
...
<div class="modal fade" id="saveWorksheetModal" role="dialog">
	...
	<div class="modal-dialog" role="document">
		...
		<div class="modal-content">
			...
			<form class="form-horizontal" action="<?php echo base_url(); ?>administrator/saveWorksheet" method="post" accept-charset="utf-8" id="save_worksheet_form">
		...
		$.ajax({
			...
			success: function(res) {
				...
				if(res == '1'){
					...
					window.location.href = '<?php echo base_url();?>administrator/generateWorksheet';
				}
