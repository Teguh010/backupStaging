				...
				<div class="row">
					...
					<div class="col-sm-9 col-md-9 col-lg-9 col-sm-pull-3 col-md-pull-3 col-lg-pull-3">
						...
						<div class="form-group">
							...
							<input type="email" name="profile_email" id="profile_email" placeholder="Email" class="form-control" disabled="disabled" value="<?=$profile_email;?>">
						</div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="profile_agency_link" id="agency_link" placeholder="http://www.hometuitioncare.com.sg/?tutorid=12345" class="form-control" value="<?=$profile_agency_link?>">
                        </div>
