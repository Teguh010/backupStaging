...
<script src="<?= base_url('js/pages/tutor/lessons.js?'.date('YmdHis')) ?>"></script>
    ...
    <div class="row">            
        <div class="col-lg-12">
            <div class="form-inline form-control-static">
                <div class="has-feedback has-search-2" style="display: inline;">
                    ...
                    <input type="text" id="searchKeyword" class="form-control search_input_control" placeholder="Search">
                </div>             
                <button class="btn btn-xl btn-teal btnNewLesson" style="display: inline; width: 205px;">New Lesson</button>       
            </div>
        </div>
        ...
        <div class="col-lg-12">
            ...
            <div class="btn-group" role="group" aria-label="Basic example">
                <button id="list" class="btn btn-default btn-sm" style="width: 80px"><span class="fa fa-th-list mr-2"></span>List</button> 
                <button id="grid" class="btn btn-default btn-sm active" style="width: 80px"><span class="fa fa-th mr-2"></span>Grid</button>
            </div>
...
<div class="section section-form" style="margin-top: -5px; display:none;">
                                    ...
                                    <div class="row p-1">
                                        ...
                                        <div class="col-lg-7 text-right">
                                            <button type="button" id="SaveLessonBtn" class="btn btn-rounded btn-outline-primary">Save and
                                                continue</button>
                                            <button type="button" id="CancelBtn" class="btn btn-rounded btn-default" style="width: 125px;">Cancel</button>
...
<?php $this->load->view('profile/tutor/data_lesson'); ?>
