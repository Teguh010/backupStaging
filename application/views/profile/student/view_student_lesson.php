<script src="<?= base_url('js/pages/student/student-lesson.js?'.date('YmdHis')) ?>"></script>
...
<div class="bg-custom">
    <div class="container">
        ...
        <div class="col-sm-12 col-md-12 col-lg-12 text-center">
            ...
            <h2 class="pb-2 text-white font500">My Lessons</h2>
        ...
        <section>
            ...
            <div class="row p-2">
                <div class="col-lg-12">
                    <div class="form-group has-feedback has-search">
						<span class="fa fa-search form-control-feedback top20"></span>
						<input type="text" id="searchKeyword" class="form-control search_input_control" placeholder="Search Lesson">
					</div>
                </div>
            </div>

            <div class="data_lesson">
            ...
            <?php
                ...
                if (count($lessons) == 0) {
                    ...
                    echo '<div class="fs24 margin-top-custom text-center">Don\'t have any lesson in the listing.</div>';
                    echo '</div>';
                    echo '</div>';
                } else {
                    $i = 1;
