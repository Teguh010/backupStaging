...
<div class="section">
	<div class="container">
		<div class="row">
			...
			?>
			<form action="<?php echo base_url(); ?>administrator/search_private_question" method="post" class="search" role="form">
			<div class="container">
					...
					<div class="worksheet_div_body">
						<div class="table-responsive">
							...
							<thead><tr class="success">
								...
								<?php
									$count = 0;
									if (count($question['question']->result()) == 0) {
										echo '<div class="student-row clearfix">';
											echo '<div class="col-xs-offset-1 col-sm-offset-1 col-md-offset-1 col-lg-offset-1 col-xs-10 col-sm-10 col-md-10 col-lg-10">';
												echo '<div class="alert alert-danger margin-top-custom text-center">Don\'t have any listing of private question.</div>';
											echo '</div>';
										echo '</div>';
									} else {
										...
										foreach ($question['question']->result() as $question_issue) {
											...
											if($question_issue->difficulty == '5'){
												$difficulty = $question['difficulty'][4];
											}else {
												$difficulty = $question['difficulty'][$question_issue->difficulty];
											}
											echo '<tr>';
											...
											echo '<td><a href="'. base_url().'administrator/privateQuestion/'.$subject.'/'.$question_issue->question_counter.'" target="_blank" class="btn btn-warning">Edit</a>';
											echo '</tr>';
											$i++;
											$count++;
										}
